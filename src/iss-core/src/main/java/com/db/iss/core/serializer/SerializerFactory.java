...
public class SerializerFactory {
	...
	private Map<SerializerType,String> className = new ConcurrentHashMap<SerializerType,String>(){{
		put(SerializerType.MSGPACK,"com.db.iss.core.serializer.msgpack.MessagePackSerializerAdapter");
		put(SerializerType.JSON,"com.db.iss.core.serializer.json.FastJsonSerializerAdapter");
	}};
