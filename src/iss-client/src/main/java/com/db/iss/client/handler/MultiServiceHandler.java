package com.db.iss.client.handler;

import com.db.iss.client.ClientProxy;
import com.db.iss.client.PackerServcice;
 ...
 */
public class MultiServiceHandler implements MethodInterceptor {
    ...
    public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
        try {
            ...
            ClientProxy.setMultiResult(null);
            long begin = System.currentTimeMillis();
            List<byte[]> rsps = context.multiCall(systemid, functionid, ClientProxy.getUserTag(), req);
            ...
            if (rsps != null) {
                ...
                for (byte[] rsp : rsps) {
                    if(rsp != null)
                        results.add(PackerServcice.getInstance().unpack(rsp, method.getReturnType()));
                    else
                        results.add(null);
                }
                ClientProxy.setMultiResult(results);
                return null;
            } else {
